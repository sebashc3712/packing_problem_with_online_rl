import os
import torch
import oskp_rl_up_with_buffer_with_mask
import pandas as pd
...
for file in cut_files:
    ...
    output_dir = os.path.join(os.getcwd(), folder_name+"_up_with_buffer_with_mask")
    ...
    final_metrics = oskp_rl_up_with_buffer_with_mask.train(instance, output_dir=output_dir, verbose=True, episode_to_show=100)
