...
for file in cut_files:
    ...
    output_dir = os.path.join(os.getcwd(), folder_name+"_up_with_buffer")
    ...
    final_metrics = oskp_rl_up_with_buffer.train(instance, output_dir=output_dir, verbose=True, episode_to_show=100)
