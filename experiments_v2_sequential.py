...
from oskp_rl_up_buffer_experiments_v2_sequential import train, DQNAgent, BoxPilingEnv, proxy_scores_for_heuristics
...
def save_visualizations(agent, episodes_boxes, output_dir, env_params, n_samples=10):
    ...
    import random
    from oskp_rl_up_buffer_experiments_v2_sequential import BoxPilingEnv, proxy_scores_for_heuristics
...
if __name__ == "__main__":
    ...
    if args.exp == 5:
        ...
        run_epoch_training(os.path.join(base_output, "exp10_epoch_training_seq_v2"), args.episodes, args.val_episodes, args.patience, args.max_epochs, args.buffer_size)
    else:
