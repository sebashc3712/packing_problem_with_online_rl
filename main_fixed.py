...
for file in cut_files:
    ...
    output_dir = os.path.join(os.getcwd(), folder_name+"_fixed")
    ...
    final_metrics = oskp_rl_fixed.train(instance, output_dir=output_dir, verbose=True, episode_to_show=100)
